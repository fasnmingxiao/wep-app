...
if(!isset($_SESSION))
	session_start();
	$user=$_SESSION["user"];
	$title="Bài tập lớn Thực Hành Cơ Sở Dữ Liệu";
?> 
...
<div id="container">
    ...
    <div id="main" style="margin-top:0px;">
		...
		if(isset($_REQUEST["b"]))
		{
			// đây sẽ là đoạn get b để xem ng dùng muốn xem trang mô
			// tuong ung vs từng trang sẽ include file cần thiết vô
			// ví dụ b = ct sẽ include file chitiet.php
			// thi chu se vo file chitiet.php de xem xu li nhu rangs
			$b=$_REQUEST["b"];
			if($b=="gioithieu")
