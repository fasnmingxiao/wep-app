  ...
  <tr>
    ...
    <strong>
		...
		if(isset($_SESSION["user"]))
		{
			...
			{	echo "$numrow"; }
			echo "<br>&raquo; <a href=\"index.php?b=showcart\"><strong>Xem Giỏ Hàng</strong></a><br>";		}
		else{
			$ghang=$_SESSION["gh"];
			$count=count($ghang);
		 	echo "$count";
			echo "<br>&raquo; <a href=\"index.php?b=gh\"><strong>Xem Giỏ Hàng</strong></a>  <br />";
		}
	?>  
    </strong>
