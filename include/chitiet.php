...
//session_destroy();
	...
	{
		$gia=$_POST["gia"];
    // day thuoc phan dat hang roi
    // con ben duoi moi lay ra chi tiet sp
	//	echo "$gia<hr>";
    // dau tien sẽ cần get cái id
    // để querry vào db lấy ra sp tương ứng vs id đấy
		$id = $_GET["id"];	
...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="25" style="padding-left:20px; border-bottom:1px dotted #666; border-right:1px dotted #666">Thuế:</td>
    <td style="border-bottom:1px dotted #666; padding-left:5px"><font color="#FF0000">Giá trên đã bao gồm thuế VAT</font></td>
  </tr>
  <tr>
