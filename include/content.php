...
?>
    ...
    <tr>
  	<td align="right" style="padding-right:10px; border-top:1px solid #999; padding-top: 10px"><a href="?b=lsp&idl=<?php echo $id_loai; ?>"><strong>Xem toàn bộ sản phẩm...</strong></a>    
    </td>
  </tr>
<?php	}
	}
